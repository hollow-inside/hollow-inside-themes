...
<div class="u-columns col2-set row" id="customer_login">
	...
	<div id="Form_LoginNow" class="u-column1 col-md-6 mx-auto">
...
<?php endif; ?>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<p class="text-center">Don't have an account? <button id="Btn_RegisterNow" class="btn btn-link pe-0" type="button">Register Now.</button>
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				<label for="username" class="form-lable"><?php esc_html_e( 'Username or email address', 'woocommerce' ); ?>&nbsp;<span class="required">*</span></label>
			...
			<p class="form-row">
				...
				<button type="submit" class="woocommerce-button button woocommerce-form-login__submit btn btn-outline-white w-100-percent mt-3" name="login" value="<?php esc_attr_e( 'Log in', 'woocommerce' ); ?>"><?php esc_html_e( 'Log in', 'woocommerce' ); ?></button>
			</p>
...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
	...
	<div id="Form_RegisterNow" class="u-column2 col-md-6 mx-auto d-none">
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
			...
			<p class="text-center">Already have an account? <button id="Btn_LoginNow" class="btn btn-link pe-0" type="button">Login Now.</button>
			...
			<p class="woocommerce-form-row form-row">
				...
				<button type="submit" class="woocommerce-Button woocommerce-button button woocommerce-form-register__submit btn btn-outline-white w-100-percent" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>"><?php esc_html_e( 'Register', 'woocommerce' ); ?></button>
			</p>
